...
Item {
    ...
    implicitWidth: root.vertical ? Math.min(colLayout.implicitWidth + 20, maxSize) : colLayout.implicitWidth
    ...
    ColumnLayout {
        ...
        StyledText {
            ...
            Layout.preferredWidth: root.vertical ? Math.min(implicitWidth, maxSize) : undefined
